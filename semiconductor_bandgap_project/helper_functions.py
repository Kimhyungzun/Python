...
def parity_plots_side_by_side(y_left_true,Y_left_predictions,y_right_true,Y_right_predictions,title_left="Training Parity Plot",title_right="Test Parity Plot"):
    ...
    ax1.scatter(y_left_true, Y_left_predictions, edgecolors=(0, 0, 0),s=60, c='g') # edgecolors=(0, 0, 0)
    ...
    ax2.scatter(y_right_true, Y_right_predictions, edgecolors=(0, 0, 0),s=60, c='r') # edgecolors=(0, 0, 0)
